...
public:
    ...
    void setupUi(QWidget *Browser)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8("icon/clear.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("icon/submit.png"), QSize(), QIcon::Normal, QIcon::Off);
...
#endif // QT_CONFIG(tooltip)
        groupBox->setTitle(QCoreApplication::translate("Browser", "SQL \350\257\255\345\217\245", nullptr));
        clearButton->setText(QCoreApplication::translate("Browser", "\346\270\205\351\231\244", nullptr));
        submitButton->setText(QCoreApplication::translate("Browser", "\346\217\220\344\272\244", nullptr));
    } // retranslateUi
